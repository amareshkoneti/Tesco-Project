# backend/utils/palette_routes.py
...
# Save or update a color palette
@palette_bp.route("/api/palettes/save", methods=["POST"])
def save_palette():
    data = request.json or {}

    conn = get_db()
    # Insert or update palette usage count
    conn.execute("""
